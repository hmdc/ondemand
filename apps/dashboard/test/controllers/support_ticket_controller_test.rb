...
class SupportTicketControllerTest < ActiveSupport::TestCase
  ...
  def set_support_ticket_config(config)
    user_configuration = UserConfiguration.new(config: { support_ticket: config })
    @controller.instance_variable_set(:@user_configuration, user_configuration)
  end
  ...
  test "create_service_class returns SupportTicketRtService when rt_api configuration object defined" do
    ...
    set_support_ticket_config({ rt_api: {} })
    service = @controller.send(:create_service_class)
  ...
  test "create_service_class throws exception when no service class configured" do
    set_support_ticket_config({})
    @controller.instance_variable_set(:@user_configuration, {support_ticket: {}})
